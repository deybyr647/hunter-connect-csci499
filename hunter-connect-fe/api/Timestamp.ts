 ...
 */
const timestampToDate = (ts: FirestoreTimestampLike | Timestamp | null | undefined): Date => {
    if (!ts) {
        return new Date();
    }
 ...
 */
const formatDateString = (ts: FirestoreTimestampLike | Timestamp | null | undefined): string => {
 ...
 */
const formatTimeString = (ts: FirestoreTimestampLike | Timestamp | null | undefined): string => {
    const date = timestampToDate(ts);
 ...
 */
const isFuture = (ts: FirestoreTimestampLike | Timestamp | null | undefined): boolean => {
    const date = timestampToDate(ts);
    return date > new Date();
};

export { timestampToDate, formatDateString, formatTimeString, formatTimeRange, isFuture };